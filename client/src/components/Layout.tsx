    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1">
          <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 mb-16 lg:mb-0">
            {children}
          </div>
        </main>

        {/* Desktop Sidebar */}
        <aside className="hidden lg:block fixed right-0 top-[72px] bottom-0 w-64 bg-white dark:bg-gray-800 border-l dark:border-gray-700 p-4 overflow-y-auto">
          <NavLinks />
        </aside>

        {/* Mobile Bottom Navigation */}
        <nav className="lg:hidden fixed bottom-0 right-0 left-0 bg-white dark:bg-gray-800 border-t dark:border-gray-700 px-2 py-2">
